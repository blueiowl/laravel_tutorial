                    ...
                    <form action="{{ route('tasks.update', ['id' => $task->id]) }}" method="post">
                        ...
                        <div class="list-group-item">
                            <span class="row">
                                ...
                                <input type="text" name="title" placeholder="タイトルを入力してください" class="col" value="{{ $task->title }}">
                            </span>
                        </div>
                        <div class="list-group-item">
                            <span class="row">
                                <label for="content" class="col">内容</label>
                                <textarea name="content" cols="30" rows="10" placeholder="内容を入力してください" class="col">{{ $task->content }}</textarea>
                            </span>
                        </div>
                        <div class="list-group-item">
                            <div class="col">
